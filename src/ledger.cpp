...
int tx_example(int argc, char** argv)
{
    ...
    std::cout << "AccessKey details : " << access_key_details.dump() << std::endl;
...
int tx_example_simple(int argc, char** argv)
{
    /*const std::string sender = argv[1];
    const std::string receiver = argv[2];
    const std::string network_id = "testnet";

    ntb::NearClient near_client(network_id);
    near_client.login(ntb::ED25519Seed{ argv[3] });
    near_client.transfer(receiver, "1.24");*/
...
int smart_contract_call_example(int argc, char** argv)
{
    const std::string sender = argv[1];
    const std::string receiver = argv[2];
    const std::string network_id = "testnet";
    ...
    auto sc_call_view_result = rpc_client.query(rpc_sc_call_view_parameters);
